...
public class TwitterServiceImpl implements TwitterService {
    ...
    public String profileURLBuilder(String userId){
        return ServletUriComponentsBuilder.fromCurrentContextPath().path("/Twitter/Non/ProfilePicture/").path(userId).toUriString();
    }

    //post url builder
    @Override
    public String postURLBuilder(BigInteger tweetId){
        return ServletUriComponentsBuilder.fromCurrentContextPath().path("/Twitter/Non/Post/").path(String.valueOf(tweetId)).toUriString();
    }
