...
public class User {
    ...
    public User(String name, String userId, String password, boolean verified, String email, BigDecimal phoneNumber, BigDecimal followersCount, BigDecimal followingCount,String role) {
        this.name = name;
        this.userId = userId;
